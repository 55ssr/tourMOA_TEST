...
public class AdminController {
	...
	/** categoryService */
	/*
	 * categoryService 서비스를 사용하기 위해 선언함 impl에서의 이름과 동일
	 */
	...
	@ResponseBody
	public Map<String, Object> insertGoods(GoodsVO vo) throws Exception {
		String result = "";
	...
	@ResponseBody
	public Map<String, Object> adminGoodsUpdate(GoodsVO vo) throws Exception {
		int cnt = 0;
		HashMap<String, Object> map = new HashMap<String, Object>();
	...
	@ResponseBody
	public Map<String, Object> adminGoodsDelete(GoodsVO vo) throws Exception {
		int cnt = 0;
		HashMap<String, Object> map = new HashMap<String, Object>();
	...
	@ResponseBody
	public Map<String, Object> adminSliderConfirm(SliderVO vo) throws Exception {
	...
	/*
	 * adminSliderWriteSave 자료 게시판 저장 기능
	 */
	@RequestMapping(value = "/adminSliderWriteSave.do")
	@ResponseBody
	public Map<String, String> multipartProcess(MultipartHttpServletRequest multiRequest, HttpServletResponse response,
	 ...
	 * 파일업로드
	 */
	public static Map<String, String> uploadFile(MultipartHttpServletRequest multiRequest, String nPath)
			throws Exception {
	...
	@ResponseBody
	public Map<String, Object> deleteSlider(HttpServletRequest request, HttpServletResponse response, GoodsVO vo,
		...
		if (cnt > 0) {
			String files = sliderDetail.getFilename(); // 파일명 읽기 위해서 detail 서비스
														// 실행
			// a.jpg;b.jpg
			if (files.length() > 0) {
	...
	@ResponseBody
	public Map<String, String> updateSlider(final MultipartHttpServletRequest multiRequest,
			HttpServletResponse response, GoodsVO vo, String code, Model model) throws Exception {
		MultipartFile file;
		String filePath = "";
		int cnt = 0;
	...
	@ResponseBody
	public Map<String, String> updateFileDelete(HttpServletResponse response, GoodsVO vo, String code)
			throws Exception {
		/* for updateOption s */
		String option = "";
		if (vo.getExpl() != null)
	...
	@ResponseBody
	public Map<String, Object> deleteOption(HttpServletRequest request, HttpServletResponse response, OptionVO vo,
			String code) throws Exception {
		...
		if (cnt > 0) {
			String files = optionDetail.getFilename(); // 파일명 읽기 위해서 detail 서비스
														// 실행
			if (files.length() > 0) {
	...
	@ResponseBody
	public Map<String, String> updateOption(final MultipartHttpServletRequest multiRequest,
			HttpServletResponse response, GoodsVO vo, String code, Model model) throws Exception {
		MultipartFile file;
		String filePath = "";
		int cnt = 0;
	...
	/*
	 * //상품평 어드민 라이트 (필요 없으므로 주석) <시작>
	 * 
	 * @RequestMapping("/adminGoodsCommWrite.do") public String
	 * adminGoodsCommWrite() { return "admin/GoodsComm/adminGoodsCommWrite"; }
	 * 
	 * //상품평 어드민 라이트:서치 (필요 없으므로 주석)
	 * 
	 * @RequestMapping("/adminGoodsCommSearch.do")
	 * 
	 * @ResponseBody Map<String, Object> adminGoodsCommSearch (
	 * 
	 * @ModelAttribute("searchVO") DefaultListVO searchVO, Model model) throws
	 * Exception {
	 * 
	 * HashMap<String, Object> map = new HashMap<String, Object>(); List<?>
	 * result = goodsService.selectGoodsSearchList(searchVO); //if
	 * (result.size() > 0) result = "ok";
	 * 
	 * map.put("result", result); model.addAttribute("resultList", result);
	 * return map; } //상품평 어드민 라이트 세이브 (필요 없으므로 주석)
	 * 
	 * @RequestMapping("/adminGoodsCommWriteSave.do")
	 * 
	 * @ResponseBody public Map<String, Object> insertComm (CommVO vo) throws
	 * Exception{
	 * 
	 * String result = "";
	 * 
	 * vo2 = goodsService.selectGoodsDetail(vo2); vo2.getTitle();
	 * System.out.println("vo2 t: " +vo2.getTitle());
	 * vo.setGtitle(vo2.getTitle());
	 * 
	 * System.out.println("vo c: " +vo.getCtitle()); System.out.println("vo g: "
	 * +vo.getGtitle()); System.out.println("vo ct: " +vo.getContent());
	 * System.out.println("vo gubun: " +vo.getGubun()); System.out.println(
	 * "vo author: " +vo.getAuthor()); System.out.println("vo pid: "
	 * +vo.getPid());
	 * 
	 * HashMap<String, Object> map = new HashMap<String, Object>(); result =
	 * goodsService.insertComm(vo); System.out.println("ssdsdsss"); if (result
	 * == null) result = "ok"; map.put("result", result); return map; } //상품평
	 * 어드민에서 라이트 (필요 없으므로 주석) <끝>
	 */
	...
	@ResponseBody
	public Map<String, Object> insertadminSave(MemberVO vo) throws Exception {
	...
	@ResponseBody
	public Map<String, Object> adminDetailUpdate(MemberVO vo) throws Exception {
		int detailupdate = 0;
		HashMap<String, Object> map = new HashMap<String, Object>();
	...
	@ResponseBody
	public Map<String, Object> adminMemberDelete(MemberVO vo) throws Exception {
	...
	public String selectCategoryList(@ModelAttribute("searchVO") SampleDefaultVO searchVO, DefaultListVO vo,
		...
		if (vo.getSrchContn() == null || vo.getSrchContn().equals("") || vo.getSrchKeywd() == null
	...
	public String adminCategoryWrite(DefaultListVO vo, Model model) throws Exception {
		...
		System.out.println("test");
		/*
		 * 변수설명 : 등록하려는 분류(카테고리)의 상위 코드 값 아래와 같은 경우의 값이 올 수 있음 ex1) 올바른 경우 :
		 * 0(대분류등록) , A01(중분류등록), A0101(소분류등록) ex2) 올바르지 않은 경우 : NULL, A1, A101,
		 * 그외 기타
		 */
		...
		/*
		 * 등록하려는 데이터 코드와 같은 항렬의 max값 가져옴 예) 0(같은 항렬이 없는 경우), A01 , A0101,
		 * A010101
		 */
	...
	@ResponseBody
	public Map<String, String> insertCtg(CategoryVO vo) throws Exception {
	...
	@ResponseBody
	public Map<String, String> updateCategory(CategoryVO vo) throws Exception {
		System.out.println("test");
		String result = "";
		int cnt = 0;
	...
	@ResponseBody
	public Map<String, String> deleteCategory(CategoryVO vo) throws Exception {
