...
/* �듯빀寃��� : 異쒕컻�쇨��� */
#searchWrap .tabview.tab02 { text-align: center; }
#searchWrap .tabview.tab02 .calendarBox { clear: both; position: relative; width: 100%; height: 346px; overflow: hidden; }

#searchWrap .control { float:left; width: 100%; height: 60px; position:absolute; bottom:0; border-top: 1px solid #dddddd; background: #f7f8f9; }
#searchWrap .control span { display: block; float: left; font-size: 14px; }
#searchWrap .control span.tit { margin: 22px 30px 0 50px; color: #333333; font-weight: 600; }
#searchWrap .control span.chk { width: 55px; margin: 22px 5px 0 0; color: #666666; }
#searchWrap .control span.chk input[type="checkbox"] { margin: 2px 5px 0 0; margin: -2px 8px 0 0 \9; vertical-align: top; }
#searchWrap .control button.btnSearch { float: left; width: 64px; height: 29px; margin: 15px 0 0 10px; background: #777777; border: 1px solid #777777; font-size: 12px; color: #fff; font-weight: 600; }

/* �듯빀寃��� : 媛�寃⑸퀎寃��� */
#searchWrap .tabview.tab03 { text-align: center; }
#searchWrap .tabview.tab03 .rangeWrap { display: inline-block; width: 760px; margin: 30px auto; }

/* 寃��됯껐怨� �뚮┝ */
#notiWrap { width: 1098px; margin: 15px auto 0; padding: 15px 0; text-align: center; border: 1px solid #ececec; }
#notiWrap span { display: block; font-size: 16px; color: #333333; }
#notiWrap span p { display: inline; font-size: 16px; color: #f8931f; font-weight: 600; }
#notiWrap span p.keywd { padding-right: 5px; }
#notiWrap div.noti { display: inline-block; width: 300px; margin: 0 auto; text-align: left; }
#notiWrap div.noti span { display: block; margin-bottom: 15px; text-align: center; }
#notiWrap div.noti p { margin: 10px 0 0 0; padding-left: 8px; background:url("/images/totSearch_bul02.png") left center no-repeat; font-size: 13px; color: #666666; }

/* 寃��됯껐怨� 移댄뀒怨좊━ */
#catWrap { width: 1100px; margin: 40px auto 0; }
#catWrap .title { width: 100%; font-size: 16px; color: #333333; font-weight: 600; }
#catWrap .title span.bul { float: left; display: block; width: 5px; height: 5px; margin: 4px 8px 0 0; background: #ffc200; }
#catWrap .title p { display: inline-block; padding: 0 0 0 5px; color: #f8931f; }
#catWrap table { width: 100%; margin: 20px 0 0 0; border-top: 1px solid #d6d6d6; }
#catWrap table tr { width: 100%; border-bottom: 1px solid #d6d6d6; font-size: 14px; text-align: left; }
#catWrap table tr th, #catWrap table tr td { padding: 20px 0 5px; vertical-align: top; }
#catWrap table tr th { width: 175px; color: #333333; font-weight: 600; }
#catWrap table tr th span a { color: #333; text-decoration: none; }
#catWrap table tr th span a:hover, 
#catWrap table tr th span a:active,
#catWrap table tr th span a:visited { color: #f8931f !important; font-weight:600 !important;  }

#catWrap.catWrap table tr th span a:hover, 
#catWrap.catWrap table tr th span a:active,
#catWrap.catWrap table tr th span a:visited { color: #333 !important; font-weight:600 !important;  }

#catWrap table tr td span { display: inline-block; float: left; width: 170px; margin: 0 15px 15px 0; }
#catWrap table tr td span a { color: #666666; }
#catWrap table tr td span a:hover,
#catWrap table tr td span a:active,
#catWrap table tr td span a:visited { color: #666666; }
#catWrap table tr td span.on {color: #f8931f !important;}

/* 寃곌낵 �� �ш��� */
#reWrap { position:relative; width: 1100px; height: 406px; margin: 40px auto 0; overflow: hidden; }
.titleBox {position:relative; width:1100px; margin: 0 auto; top:35px;z-index:1;}
.titleBox .title { float:left; width:11%; font-size:16px; color: #333333; font-weight: 600; top:5px }
.titleBox .title span.bul { float:left; display:block; width: 5px; height: 5px; margin: 4px 8px 0 0; background: #ffc200; }
.titleBox .bntOption {display: block;float: left;padding: 5px 7px 3px 8px;border: 1px solid #ddd;background-color: #fff;font-size: 12px;color: #494949;letter-spacing: -1px;text-decoration: none;line-height: 15px;}
.spim {overflow: hidden; background: url("/images/area/sp_layout.png")center center no-repeat; white-space: nowrap; vertical-align: middle;}
.titleBox .bntOption .spim {display: inline-block; width: 7px; height: 5px; margin: 4px 0 -4px 5px; background-position: 0 0; vertical-align: top;}
.titleBox .bntOption.on .spim {background-position: -10px 0;}
#reWrap ul.frm { clear:both; float: left; display: inline-block; width: 825px; margin: 38px 0; border: 1px solid #d6d6d6; border-left: none; border-right: none; }
#reWrap ul.frm li { float: left; width: 254px; min-height: 320px; padding: 0 0 0 20px; margin: 18px 0; border-left: 1px solid #ececec; font-size: 14px; }
#reWrap ul.frm li:first-child { border-left: none; }
#reWrap ul.frm li span.tit { display: block; clear: both; margin-bottom: 10px; color: #333333; font-weight: 600; }
#reWrap ul.frm li #keyword {width: 208px; height: 32px; border: 1px solid #ddd; margin-bottom: 10px;}
#reWrap ul.frm li span.txt { display: block; clear: both; font-size: 13px; color: #999999; line-height: 1.2; }
#reWrap ul.frm li > select { float: left; width: 210px; /*height: 34px;*/ margin: 0 0 30px 0; padding: 8px 10px 8px 10px; padding: 7px 10px 7px 10px \9; line-height: 30px; border: 1px solid #dddddd; font-size: 14px; color: #666666; font-weight: normal; }
#reWrap ul.frm li span.inputWrap { float: left; width: 208px; height: 34px; margin: 0 0 30px 0; border: 1px solid #dddddd; overflow: hidden; }
#reWrap ul.frm li span.inputWrap input { float: left; width: 155px; /*height: 34px;*/ margin: 0 0 30px 0; padding: 9px 10px 9px 10px; padding: 8px \9; border: none; font-size: 14px; color: #666666; font-weight: normal; }
#reWrap ul.frm li span.inputWrap button { float: right; width: 32px; height: 34px; border: none; background: #fff url('/images/find_icon02.png') center center no-repeat; }
.optionMenu {display:block}
#reWrap ul.frm li .term { width: 174px; margin: 0 0 30px 0; padding: 9px 20px 10px 14px; padding: 9px 20px 10px 14px \9 !important; border: 1px solid #dddddd; background: #fff url("/images/find_icon02.png") no-repeat 184px center !important; font-size: 13px; cursor: pointer; }
::-webkit-input-placeholder { font-size: 13px !important; color: #999 !important; font-weight: normal; }
::-moz-placeholder { font-size: 13px !important; color: #999 !important; font-weight: normal; } /* firefox 19+ */
:-ms-input-placeholder { font-size: 13px !important; color: #999 !important; font-weight: normal; } /* ie */
input:-moz-placeholder { font-size: 13px !important; color: #999 !important; font-weight: normal; }
input[type="text"].research_box {border:1px solid #666 ; height:30px; width:205px ;} 

#reWrap ul.frm li span.chk { display: block; float: left; width: 70px; margin: 0 10px 12px 0; font-size: 14px; color: #666666; }
#reWrap ul.frm li span.chk input[type="checkbox"] { margin: 2px 5px 0 0; margin: -2px 5px 0 0 \9; vertical-align: top; }
#reWrap ul.frm li span.chkPrice { display: block; margin: 0 0 15px 0; font-size: 14px; color: #666666; }
#reWrap ul.frm li span.chkPrice input[type="checkbox"] { margin: 2px 5px 0 0; margin: -2px 5px 0 0 \9; vertical-align: top; }
#reWrap ul.frm li span.chkPrice input[type="text"] { float: left; width: 75px; margin-top: -5px; padding: 7px 10px 7px 10px; padding: 8px \9; border: 1px solid #dddddd; }
#reWrap ul.frm li span.chkPrice input[type="text"]:first-child { margin-left: 20px; }
#reWrap ul.frm li span.chkPrice span.divide { float: left; margin: 4px; }
#reWrap ul.frm li input#detailKeyword { float: left; width: 188px; width: 192px \9; /*height: 34px;*/ margin: 0 0 10px 0; padding: 9px 10px 9px 10px; padding: 8px \9;  border: 1px solid #dddddd; font-size: 14px; color: #666666; font-weight: normal; }
#reWrap ul.frm li button.btnReSearch { float: left; width: 74px; height: 30px; margin: 10px 5px 0 0; background: #777777; border: 1px solid #777777; font-size: 12px; color: #fff; font-weight: 600; }
#reWrap ul.frm li button.btnReset { float: left; width: 74px; height: 30px; margin: 10px 5px 0 0; background: #fff; border: 1px solid #777777; font-size: 12px; color: #666666; font-weight: 600; }
#reWrap #rank { float: right; width: 245px; height: 395px; border: 1px solid #d6d6d6; overflow:hidden;}
#reWrap #rank .tab { float: left; width: 122px; height: 34px; margin-bottom: 20px; border-bottom: 1px solid #d6d6d6; font-size: 15px; color: #333333; font-weight: 600; text-align: center; line-height: 2.2; cursor: pointer; background:#f7f8f9;}
#reWrap #rank .tab:first-child { border-right: 1px solid #d6d6d6; }
#reWrap #rank .tab.on { background: #fff; border-bottom:none !important; z-index:1;}
#reWrap #rank ul.rankList.tab01 { display: block; }
#reWrap #rank ul.rankList.tab02 { display: none; }
#reWrap #rank ul.rankList { clear: both; width: 100%; height: 100%; }
#reWrap #rank ul.rankList li { position: relative; width: 100%; height: 18px; padding: 0 20px; margin: 15px 0 0 0; }
#reWrap #rank ul.rankList li:first-child { margin: 20px 0 0 0; }
#reWrap #rank ul.rankList li span { float: left; display: block; font-size: 14px; color: #333333; line-height: 1.2; }
#reWrap #rank ul.rankList li span.no { clear: both; width: 16px; height: 16px; border: 1px solid #c4c4c4; font-size: 12px; background: #dddddd; color: #666666; text-align: center; }
#reWrap #rank ul.rankList li span.no.grade { border: 1px solid #e3ae00; font-size: 12px; background: #fec300; color: #fff; }
#reWrap #rank ul.rankList li span.name { width: 115px; margin: 0 0 0 14px; margin: 1px 0 0 14px \9; cursor: pointer; }
#reWrap #rank ul.rankList li span.updown { width: 15px; height: 100%; margin: 0 15px; background: url('/images/totSearch_icon01.png') 7px center no-repeat; }
#reWrap #rank ul.rankList li span.updown.new {background:url(/images/ico_search_new.png) no-repeat 50% 50%; width:48px}
#reWrap #rank ul.rankList li span.updown.new+span.num {display:none}
#reWrap #rank ul.rankList li span.updown.up { background: url('/images/totSearch_icon02.png') 7px center no-repeat; }
#reWrap #rank ul.rankList li span.updown.down { background: url('/images/totSearch_icon03.png') 7px center no-repeat; }
#reWrap #rank ul.rankList li span.updown.ico_new {font-size:10px; font-family:verdana; color:red} /* new 異붽� */
#reWrap #rank ul.rankList li span.num { color: #999999; }
