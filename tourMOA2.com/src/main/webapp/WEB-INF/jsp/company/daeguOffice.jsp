...
<input type="hidden" id="pn" value="daeguOffice.do">
...
<section id="content"><!--[[ content Start ]]-->
        ...
        <div class="c_location" id="c_location">
            <ul class="locationTab">
                ...
                <li id="daeguOffice" class="on last"><a href="daeguOffice.do">대구지사</a></li>
            </ul>
            <div class="addrTxt">
                <span class="addrTop">(700-742)대구광역시 중구 달구벌대로 2095 삼성생명빌딩 11층</span>
                <span>대표전화 053-720-7744 / 대표팩스 053-428-7745</span>
            </div>
            <!--<div class="loca_map" id="loca_map">
                 <img src="/images/company/map_daegu.jpg" alt="대구지사약도"> 
            </div>-->
             <div class="norang_map">
            	<img src="/images/company/img_norang_map03.jpg" alt="투어모아 대구지사" class="img_map" />
            </div>
            <table class="direction">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <span class="sub03">지하철 1호선 반월당역 14번 출구로 나오시면 삼성생명빌딩 11층에 위치(1층 대구은행)</span>
                            <span class="sub02">지하철 2호선 반월당역 14번 출구로 나오시면 삼성생명빌딩 11층에 위치</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="rout">
                                <span class="locaTit">현대백화점 동아쇼핑앞 정류장</span>
                                <span class="routB clear">간선</span><span>35, 405, 609</span>
                            </div>
                            <div class="rout mgb0">
                                <span class="locaTit">서면 정류장</span>
                                <span class="routB clear">간선</span><span>106, 202, 303-1, 349, 401, 410-1, 518, 650, 704, 730, 760, 909</span>
                                <span class="routG last clear">지선</span><span>북구2, 동구1-1</span>
                                <span class="routR last clear">급행</span><span>급행2</span>
                            </div>
                        </td>
                    </tr>
                </tbody>
