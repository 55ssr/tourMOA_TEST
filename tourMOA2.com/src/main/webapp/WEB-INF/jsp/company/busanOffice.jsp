...
<body>
    ...
    <header><!--[[ header Start ]]-->
        ...
        <div id="top"><!--[[ top Start ]]-->
            <div id="topArea">
                <ul id="topRight">
                    <li><a href="http://www.tourmoa.co.kr"><img src="/images/company/top_R_menu01.png" alt="투어모아 바로가기"></a></li>
        ...
        <nav id="gnb"><!--[[ GNB Start ]]-->
            ...
            <ul>
                <li class="gnb01">
                    <a href="/info/intro.do" title="회사소개">회사소개</a>
                </li>
                <li class="gnb02">
                    <a href="/ceo/koh.do" title="CEO소개">CEO소개</a>
                </li>
                <li class="gnb03">
                    <a href="/agent/about.do" title="대리점안내">대리점안내</a>
                </li>
                <li class="gnb04">
                    <a href="/bizTravel/guideBizTravel.do" title="기업/단체">기업/단체</a>
                </li>
                <li class="gnb05">
                    <a href="/news/press.do" title="뉴스&보도자료">뉴스&보도자료</a>
                </li>
                <li class="gnb06">
                    <a href="/recruit/rightPeople.do" title="채용정보">채용정보</a>
                </li>
            </ul>
        </nav><!--[[ GNB End ]]-->
        ...
        <div class="top_banner">
            <ul class="tabWrap">
                <li class="tab intro_tab01"><a href="/info/intro.do">투어모아회사소개</a></li>
                <li class="tab intro_tab02"><a href="/info/svcCharter.do">고객만족경영</a></li>
                <li class="tab intro_tab03"><a href="/info/ethicsGuide.do">윤리경영</a></li>
                <li class="tab intro_tab04"><a href="/info/ciGuide.do">CI소개</a></li>
                <li class="tab intro_tab05"><a href="/info/headOffice.do">위치안내</a></li>
            </ul>
        </div>
...
<input type="hidden" id="pn" value="busanOffice.do">
...
<section id="content"><!--[[ content Start ]]-->
        ...
        <div class="c_location" id="c_location">
            <ul class="locationTab">
                <li id="headOffice"><a href="headOffice.do">본사</a></li>
                <li id="busanOffice" class="on"><a href="busanOffice.do">부산지사</a></li>
                <li id="daeguOffice" class="last"><a href="daeguOffice.do">대구지사</a></li>
            </ul>
            <div class="addrTxt">
                <span class="addrTop">(614-845)부산광역시 진구 중앙대로 708 부산 파이낸스센터 13층 ( 구.SC제일은행 빌딩 )</span>
                <span>대표전화 051-710-7744 / 대표팩스 051-710-3993</span>
            </div>
           <!-- 161024 <div class="loca_map" id="loca_map">
                 <img src="/images/company/map_busan.jpg" alt="부산지사약도">
            </div> -->
             <div class="norang_map">
            	<img src="/images/company/img_norang_map02.jpg" alt="투어모아 부산지사" class="img_map" />
            </div>	
            <table class="direction">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <span class="sub03">지하철 1호선 서면역 2번 출구로 나오시면 쥬디스태화(범내골) 방면으로 60미터. SC제일은행 빌딩 13층 위치 </span>
                            <span class="sub02">지하철 2호선 서면역 6번 출구로 나오셔서 쥬디스태화(범내골) 방면으로 100미터. SC제일은행 빌딩 13층 위치</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="rout">
                                <span class="locaTit">서면역(양측)</span>
                                <span class="routG clear">일반</span><span>10, 103, 108, 111, 133, 138, 138-1, 160, 167, 169-1, 17, 20, 23, 24, 29, 43,   
        5-1, 52, 54, 57, 583, 63, 67, 68, <br/>80, 81, 83, 83-1, 85, 86, 88(A), 88(B), 99 </span>
        						<span class="routB clear">좌석</span><span>1004(심야)</span>
                                <span class="routR clear">급행</span><span>1000, 1000(심야), 1002(심야), 1004, 1010, 1010(심야)</span>
                            </div>
                            <div class="rout mgb0">
                                <span class="locaTit">서면 정류장</span>
                                <span class="routG clear">일반</span><span>10, 83, 83-1, 88A, 88B, 111, 583</span>
                                <span class="routR last clear">급행</span><span class="last">1010</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <span>서면 중앙대로에서 서면 로터리 방면 직진 후 로터리 50미터 전 우측편</span>
                        </td>
                    </tr>
                </tbody>
            </table>
